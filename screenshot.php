...
<rect width="1200" height="900" fill="#006098"/>
<rect x="0" y="0" width="1200" height="76" fill="#ffffff"/>
<text x="40" y="50" font-family="Arial" font-size="22" font-weight="bold" fill="#006098">Mãos Pequenas · Lar Assistencial</text>
<text x="600" y="420" font-family="Arial" font-size="48" font-weight="bold" fill="#ffffff" text-anchor="middle">Cada criança merece</text>
<text x="600" y="480" font-family="Arial" font-size="48" font-weight="bold" fill="#F8F010" text-anchor="middle">um lar cheio de amor</text>
