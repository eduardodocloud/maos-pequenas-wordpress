...
<section class="section" id="itens">
 ...
 ['','Cama e Banho','Lençóis, fronhas, toalhas e cobertores em bom estado.'],
 ];
...
<section class="donation-cta" id="parceria">
 ...
 <a href="mailto:<?= esc_attr(mp_opt('mp_email','larmaospequenas@larmp.org.br')); ?>" class="btn btn-primary btn-lg">Enviar E-mail</a>
